...
import br.com.californiamobile.youfood.model.Categoria;
import br.com.californiamobile.youfood.viewHolder.MenuViewHolder;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNome = headerView.findViewById(R.id.nav_txtNome);
        //txtNome.setText(Common.currentUser.getName());
    ...
    private void loadMenu() {
        ...
        adapter = new FirebaseRecyclerAdapter<Categoria, MenuViewHolder>(Categoria.class, R.layout.menu_item,
                        MenuViewHolder.class, categoria) {
            @Override
            protected void populateViewHolder(MenuViewHolder viewHolder, Categoria model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        //Vamos pegar o id da categoria e enviar para a nova Activity
